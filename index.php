            ...
            <div class="carousel-inner">
                ...
                <div class="carousel-item active">
                    ...
                    <div class="carousel-caption d-md-block">
                        ...
                        <p>
                            Tempat pangkas rambut kami adalah tempat yang diciptakan khusus untuk pria yang menghargai
                            <br>
                            kualitas premium, waktu dan tampilan sempurna.
                        </p>
                    </div>
                </div>
                <!-- SECOND SLIDE -->
                <div class="carousel-item">
                    ...
                    <div class="carousel-caption d-md-block">
                        <h3>It's Not Just a Haircut, It's an Experience.</h3>
                        <p>
                            Tempat pangkas rambut kami adalah wilayah yang diciptakan khusus untuk pria yang menghargai
                            <br>
                            kualitas premium, waktu dan tampilan sempurna.
                        </p>
                    </div>
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="about_content" style="text-align: center;">
                    ...
                    <p style="color: #777">
                        Tukang cukur adalah seseorang yang pekerjaannya terutama memotong dan
                        mencukur rambut pria dan anak laki-laki. Tempat kerja seorang tukang cukur dikenal sebagai
                        "barbershop" atau "barber's". Tempat pangkas rambut juga menjadi tempat interaksi sosial dan
                        wacana publik. Dalam beberapa kasus, tempat pangkas rambut juga merupakan forum publik.
                    </p>
            ...
            <div class="col-md-6 offset-md-6">
                <form action="appointment.php" method="post" id="appointment_form"
                    ...
                    <div class="book_content">
                        ...
                        <p style="color: #999;">
                            Barber is a person whose occupation is mainly to cut dress groom <br>style and shave men's
                            and boys hair.
                        </p>
                    </div>
