...
/*
    ...
    CLIENTS CATEGORIES PAGE ==== > ADD SERVICE CATEGORY BUTTON IS CLICKED

    ========================================
*/

$('#edit_client_bttn').click(function() {
    var client_id = $('#edit_client_id').val();
    var first_name = $('#edit_first_name_input').val();
    var last_name = $('#edit_last_name_input').val();
    var phone_number = $('#edit_phone_number_input').val();
    var client_email = $('#edit_client_email_input').val();

    $.ajax({
        url: 'ajax/client_crud.php',
        type: 'POST',
        data: {
            action: 'Edit',
            client_id: client_id,
