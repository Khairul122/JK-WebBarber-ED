                    ...
                    ?>
                        <div class="card shadow mb-4">
                            ...
                            <div class="card-body">
                                ...
                                <a href="employees.php?do=Add" class="btn btn-primary btn-sm" style="margin-bottom: 10px;">
                                ...
                                if(isset($_POST['add_new_employee']) && $_SERVER['REQUEST_METHOD'] == 'POST' && $flag_add_employee_form == 0)
                                {
                                    ...
                                    try
                                    {
                                        ...
                                        ?> 
                                            ...
                                            $message = "<script>alert('data berhasil di masukkan'); window.location.replace("employees.php")</script>;
                                        ...
                                        if(isset($_POST['edit_employee_sbmt']) && $_SERVER['REQUEST_METHOD'] == 'POST' && $flag_edit_employee_form == 0)
                                        {
                                            ...
                                            try
                                            {
                                                ...
                                                ?> 
                                                    ...
                                                    $message = "<script>alert('data berhasil di edit'); window.location.replace("employees.php")</script>;
