                ...
                ?>
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <a href="services.php?do=Add" class="btn btn-primary btn-sm" style="margin-bottom: 10px;">
                            ...
                            <table class="table table-bordered table table-hover">
                                ...
                                <thead>
                                    <tr>
                                        <th scope="col" style="font-weight: bold; color: black;">Service Name</th>
                                        <th scope="col" style="font-weight: bold; color: black;">Service Category</th>
                                        <th scope="col" style="font-weight: bold; color: black;">Description</th>
                                        <th scope="col" style="font-weight: bold; color: black;">Price</th>
                                        <th scope="col" style="font-weight: bold; color: black;">Duration</th>
